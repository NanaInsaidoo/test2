...
const validationSchemaArray=  [
    ...
    Yup.object().shape({
      ...
      Yup.object().shape({
        ...
        staffSecondaryPhoneNumber :Yup.string().min(2, 'Too Short!').max(50, 'Too Long!').required('Required'),
        staffEmail :Yup.string().min(2, 'Too Short!').max(50, 'Too Long!').required('Required'),
        confirmstaffEmail :Yup.string().min(2, 'Too Short!').max(50, 'Too Long!').required('Required'),
        ...
        dateHired :Yup.string().min(2, 'Too Short!').max(50, 'Too Long!').required('Required'),
        uploadPicture :Yup.string().min(2, 'Too Short!').max(50, 'Too Long!').required('Required'),
        uploadResume :Yup.string().min(2, 'Too Short!').max(50, 'Too Long!').required('Required'),
        uploadID :Yup.string().min(2, 'Too Short!').max(50, 'Too Long!').required('Required'),
        
      }),
      Yup.object().shape({
     levels: Yup.array().of(
        Yup.object().shape({
          classLevelsName: Yup.string().min(2, 'Too Short!').max(50, 'Too Long!').required('Required'),
          classLevelsQuantity: Yup.string().min(2, 'Too Short!').max(50, 'Too Long!').required('Required'),
