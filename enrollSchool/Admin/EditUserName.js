  ...
  const [open, setOpen] = React.useState(false);
   ...
   const formik = useFormik({
     ...
     validationSchema: Yup.object({
      editUserName: Yup.string().matches("^[A-Za-z0-9]*$","special characters Not allowed ")
    ...
    setOpen(false);
     ...
     <form onSubmit={formik.handleSubmit}>
       <TextField
          ...
          variant="outlined"
          fullWidth
          helperText=   {formik.touched.editUserName && formik.errors.editUserName ? (
            <div>{formik.errors.editUserName}</div>
          ) : null}
          error = {formik.touched.editUserName && formik.errors.editUserName }
        />
