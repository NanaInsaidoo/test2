            ...
            >
                ...
                <Grid item sm={10} md ={10} lg={6} className={classes.item0} >
                    ...
                    >
                        ...
                        <Box borderColor="red" mt={3} mb={5} fontWeight="Bold" fontSize={20} textAlign="left">Add a School</Box>
                        <Box mt={6}>
                            ...
                            <Grid container>
                                ...
                                <Grid item xs={12} md={6}>
                                    <label >
                                        <Box mb={1} mt={3}  fontWeight="fontWeightMedium"> Class Name:</Box> 
                                                <input type="text" className={classes.inputbox} />
                                    </label>
                                </Grid>
                                ...
                                <Grid xs={12} md={6}>
                                    <label >
                                        <Box mb={1} mt={3}  fontWeight="fontWeightMedium"> Class Alias:</Box>
                                                 <input type="text" className={classes.inputbox} />
                                    </label>
                                </Grid>
                                ...
                                <Grid xs={12}>
                                     ...
                                     <Box mb={1} mt={3}  fontWeight="fontWeightMedium"> Class Subject:</Box>
                                </Grid>
                                <Grid xs={12} md={6}>
                                    <label >
                                        <Box mb={1} mt={3}  fontWeight="fontWeightMedium"> Class Fee :</Box>
                                                 <input type="text" className={classes.inputbox} />
                                    </label>
                                </Grid>
